...
set ISE_MAJOR_MINOR_NIGHTLY=19.11
set ISE_BUILD_NIGHTLY=103699
...
:GET_DOWNLOAD
	...
	%extract_cmd% x %TMP_DOWNLOAD_ARCHIVE_7z% -y > NUL
	...
	echo setx ISE_PLATFORM %ISE_PLATFORM%>> %ISE_RC_FILE%
	echo setx ISE_EIFFEL "%ISE_EIFFEL%">> %ISE_RC_FILE%
	echo setx PATH "%%ISE_EIFFEL%%\studio\spec\%%ISE_PLATFORM%%\bin";"%%ISE_EIFFEL%%\tools\spec\%%ISE_PLATFORM%%\bin";"%%ISE_EIFFEL%%\library\gobo\spec\%%$ISE_PLATFORM%%\bin";"%%ISE_EIFFEL%%\esbuilder\spec\%%ISE_PLATFORM%%\bin";"%%PATH%%">> %ISE_RC_FILE%
	echo setx ISE_C_COMPILER msc_vc140>> %ISE_RC_FILE%
	type %ISE_RC_FILE%
